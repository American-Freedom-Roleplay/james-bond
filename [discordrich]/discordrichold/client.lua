Citizen.CreateThread(function()
	while true do
		SetDiscordAppId(618056842794369037) --Discord app id
		SetDiscordRichPresenceAsset('new_project_3_1_1_') --Big picture asset name
        SetDiscordRichPresenceAssetText('PA:RPX') --Big picture hover text
        SetDiscordRichPresenceAssetSmall('new_project_3_1_1_') --Small picture asset name
        SetDiscordRichPresenceAssetSmallText('PA:RP') --Small picture hover text
