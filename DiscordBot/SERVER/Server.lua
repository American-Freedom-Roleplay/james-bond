...
-- System Infos
PerformHttpRequest(DiscordWebhookSystemInfos, function(Error, Content, Head) end, 'POST', json.encode({username = SystemName, content = '**Sunucu Açıldı**'}), { ['Content-Type'] = 'application/json' })
